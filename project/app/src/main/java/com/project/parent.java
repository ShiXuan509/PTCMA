...
public class parent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Email = (EditText) findViewById(R.id.etParentEmail);
        Password = (EditText) findViewById(R.id.etParentPassword);
        BtnLogin = (Button) findViewById(R.id.btnParentLogin);
        Forgot_Password = (TextView) findViewById(R.id.tvParentForgotPassword);
        ...
        BiometricPrompt biometricPrompt = new BiometricPrompt(parent.this, executor, new BiometricPrompt.AuthenticationCallback() {
...
//                startActivity(new Intent(getApplicationContext(),adminmenu.class));
                firebaseAuth.signInWithEmailAndPassword(Email.getText().toString(),Password.getText().toString())
                                ...
                                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        if (snapshot.exists()) {
                                            ...
                                            startActivity(new Intent(getApplicationContext(),parentmenu.class));
                                            finish();
                                        } else {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) { Toast.makeText(parent.this,e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
            }
    ...
    private void beginReset(String email) {
        firebaseAuth.sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(parent.this, "Check You Email to get Your Reset Link",Toast.LENGTH_LONG).show();
                        }else {
                            Toast.makeText(parent.this,"Failed...",Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(parent.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void validate (String userEmail, String userPassword){
        if (userEmail.isEmpty() || userPassword.isEmpty()){
            Toast.makeText(parent.this,"Please fill in your email and password",Toast.LENGTH_SHORT).show();
            return;
        }
        else{
            Intent intent = new Intent(parent.this,parentmenu.class);
