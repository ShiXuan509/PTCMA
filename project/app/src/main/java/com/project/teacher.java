...
public class teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Email = (EditText) findViewById(R.id.etTeacherEmail);
        Password = (EditText) findViewById(R.id.etTeacherPassword);
        BtnLogin = (Button) findViewById(R.id.btnTeacherLogin);
        Forgot_Password = (TextView) findViewById(R.id.tvTeacherForgotPassword);
        ...
        BiometricPrompt biometricPrompt = new BiometricPrompt(teacher.this, executor, new BiometricPrompt.AuthenticationCallback() {
...
//                startActivity(new Intent(getApplicationContext(),adminmenu.class));
                firebaseAuth.signInWithEmailAndPassword(Email.getText().toString(),Password.getText().toString())
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) { Toast.makeText(teacher.this,e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
            }
    ...
    private void beginReset(String email) {
        firebaseAuth.sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(teacher.this, "Check You Email to get Your Reset Link",Toast.LENGTH_LONG).show();
                        }else {
                            Toast.makeText(teacher.this,"Failed...",Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(teacher.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void validate (String userEmail, String userPassword){
        if (userEmail.isEmpty() || userPassword.isEmpty()){
            Toast.makeText(teacher.this,"Please fill in your email and password",Toast.LENGTH_SHORT).show();
            return;
        }
        else{
            Intent intent = new Intent(teacher.this,teachermenu.class);
