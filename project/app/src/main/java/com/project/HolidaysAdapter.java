...
public class HolidaysAdapter extends FirebaseRecyclerAdapter <HolidaysModel, HolidaysAdapter.viewholder> {
    Task<Void> myTask;
     ...
     * @param options
     */
    public HolidaysAdapter(@NonNull FirebaseRecyclerOptions<HolidaysModel> options) {
        super(options);
    }
